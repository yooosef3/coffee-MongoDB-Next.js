            ...
            <div style={{backgroundImage: `url(${mainBg.src})`}} className='bg-cover py-20 lg:px-10 bg-no-repeat bg-center'>
                <div className="lg:w-[95%] mx-auto flex flex-col lg:flex-row lg:justify-center">
                    ...
                    <div className='mx-auto w-fit mb-6'>
                        <label className='font-semibold text-gray-500' htmlFor="sort">دسته بندی براساس:</label>
                        <select defaultValue='all' name="sort" id="sort" className='bg-white text-black font-bold pr-auto mr-2 pr-4 outline-none focus:shadow-md w-[100px] text-center rounded-lg'>
                    ...
                    <section>
                        ...
                        <ul className='text-gray-500'>
                            <li className='my-2 hover:text-[#52A16F] font-semibold cursor-pointer duration-200'>عربیکا سبز</li>
                            <li className='my-2 hover:text-[#52A16F] font-semibold cursor-pointer duration-200'>قهوه برشته لایت</li>
                            <li className='my-2 hover:text-[#52A16F] font-semibold cursor-pointer duration-200'>قهوه برشته مدیوم</li>
                            <li className='my-2 hover:text-[#52A16F] font-semibold cursor-pointer duration-200'>قهوه برشته تیره</li>
                        </ul>
                    </section>
                    ...
                    <section className="mt-14 ">
                        <div className="relative h-12 shadow-lg">
                            <input type="search" className='w-full rounded-lg border border-gray-300 focus:border-blue-500 bg-white outline-none h-full pr-2 text-lg font-semibold text-black' placeholder='جستجو...' />
