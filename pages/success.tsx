...
const Success = () => {
  ...
  return (
    <div className="h-screen flex gap-10 flex-col justify-center items-center">
      <div className="flex gap-3 justify-center items-center bg-green-200 rounded-xl p-10 animate-bounce">
        <AiFillCheckCircle className="text-4xl text-green-600" />
        <h1 className="font-bold text-lg lg:text-3xl text-green-700">پرداخت شما با موفقیت انجام شد!</h1>
      </div>
